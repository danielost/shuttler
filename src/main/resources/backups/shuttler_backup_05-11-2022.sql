...
INSERT INTO `route` VALUES (1,21,0,2),(2,22,0,2),(3,25,0,2),(4,6,2,2);
...
INSERT INTO `route_stop` VALUES (1,1),(2,1),(3,1),(4,1),(1,2),(2,2),(3,2),(2,3),(4,3),(3,4),(4,4);
...
INSERT INTO `stop` VALUES (1,2,'Kushanryova'),(2,6,'Kvartalna'),(3,14,'Nauky ave'),(4,86,'Nauky ave'),(5,112,'Halytska');
...
INSERT INTO `user` VALUES (1,'Danylo','Ostapchenko','$2a$12$QlGzi2rudaWa17F/JdmBj.soxvmLIm7GKz7F.0zILhruff393X9nm','danost'),(2,'Denys','Samoyed','$2a$10$79UW3pZkQ8NQSvMt2x.nwORrf/z1wVVzaHbHK9GyO7ZtgwPrXNDFG','samoyed'),(4,'IoT-Contoller#1','-','$2a$10$rnAaUMgM4XqkrWYR4bDLhezfINXUeCFep/9rzh0TigLs1bABwHhua','control1');
...
INSERT INTO `user_roles` VALUES (1,1),(1,2),(2,1),(2,3),(4,1),(4,4);
...
INSERT INTO `vehicle` VALUES ('SALVA2AE4EH877322',11,119,2,2),('SALVA2AE4EH8787322',11,119,2,2),('SALVA2AE4EXEH8787322',4,35,2,3);
...
-- Dump completed on 2022-11-05  0:05:00
